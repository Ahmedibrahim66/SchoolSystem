...
class CustomDialog2 extends StatelessWidget {
  ...
  final List<StudentHomeworkAndExams> homeworkAndExams;
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView.builder(
                itemCount: homeworkAndExams.length,
                itemBuilder: (context, index) {
                  return Flexible(
                    child: Row(
                      ...
                      children: <Widget>[
                        Flexible(
                            child: Text(homeworkAndExams[index].jobDescription,
                                textAlign: TextAlign.center,
                                style: AppThemeData().tajwalText.copyWith(
                        ...
                        Flexible(
                          child: Text(
                              "${type[int.parse(homeworkAndExams[index].materialType) - 1]} :",
