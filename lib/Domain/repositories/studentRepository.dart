...
abstract class StudentRepository {
  ...
  Future<List<ScheduleSubjectModel>> getStudentDaySchedual(
      String token, String userId, int day);
  ...
  Future<List<DaysOfWeekModel>> getWeekDays(
      String token, String weekNum, String year);
  ...
  Future<List<ChatModel>> getChatListChat(
      String token, String userId, String chatRoomId);
  Future sendChatMessaeg(
      String token, String userId, String chatRoomId, String message);

  //view exam to review
  Future<List<StudentExamModel>> getStudentExamsList(
      String token, String userId);
  Future<List<ExamQuestionReviewModel>> enterStudentExamReview(
      String token, String userId, int examId);
  Future<List<ExamQuestionReviewModel>> getStudentExamReviewQuestion(
      String token, String userId, int examId, int questionSeq);
  ...
  Future<String> submitQuestionAnswer(String token, String userId, int examId,
      int questionSeq, String selectedAnswer, String isEnd, File file);

  //view zoom links
  Future<List<ZoomLinkModel>> getZoomLinks(
    String token,
    String userId,
  );
  ...
  Future<bool> submitHomeWork(
      String token, String studentNumber, String seq, List<File> files);
